...
<body>
  <nav  class="sticky-top navbar navbar-expand-lg navbar-light bg-light border-bottom p-4 ">
    ...
    <div class="container-fluid my-5">
      ...
      <div class="container ">
      <div class=" my-auto mx-auto container mb-5">
          <p>Below is our contact details, you can call us at: 012 554 8897</p>
          <p>You can also fill the form and send us an email below</p>
          </div>
          ...
          <form action="" method="post" class='container container-light bg-light rounded p-5'>
              ...
              <div class="row">
                    ...
                    <div class="mb-3">
                      <label class="fomr-label">Subject</label>
                      <input type="text" class='form-control' placeholder='Subject'>
                    </div>
                    <div class="mb-3">
                      <label class="fomr-label">Message</label>
                      <textarea name="" id="" class='form-control' placeholder="Write Us A Message..."  rows="3"></textarea>
                </div>
            </div>
...
<!-- Footer Section -->
<footer class="container-fluid container-light bg-light sticky-bottom footer mt-4">
      <div class="row">
        <div class="col-4">
