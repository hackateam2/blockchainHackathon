...
<body height='100vh'>
  ...
  <div class="hero"
  style="background-image: url('/Blockchain Hackathon/assets/images/pexels-fauxels-3183197.jpg');"
  >

    <div class="color-overlay d-flex 
    justify-content-center align-items-center">
      <h1>FundRaise is a platform made for business owners and innovators to get on their feet and make their idea more than just a thought</h1>
    </div>
  </div>

  <div class="container my-5" >
    <h2 class="display-4">Fund<span class="text-primary">Raise</span></h2>
      <p>The pandemic really led to many issues, such that some of them was people being retrenched from their jobs, businesses facing downfalls because they had run out of funds to fuel them and keep them moving.</p>
      <p>As a result of this we created this platform for innovators and business owners in need of funds to make their dream more of a reality.</p> 
      <p>This platform helps out people get themselves out there and start building their future and potentially other people's future, because they could see themselves being employers to other one day.</p>
    </div>


<!-- Footer Section -->
<footer class="container-fluid container-light bg-light fixed-bottom mt-4">
      <div class="row">
        <div class="col-4">
