    ...
    <div class="row g-3">
      <div class="col-12 col-md-6 col-lg-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, consequuntur?</p>
            <p class="card-text">Business ID: <span>B01</span></p>
      ...
      <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Title</h5>
            <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt, consequuntur?</p>
            <a href="#" class='btn btn-primary'>Fund</a>
          </div>
        </div>
      </div> -->
    </div>
