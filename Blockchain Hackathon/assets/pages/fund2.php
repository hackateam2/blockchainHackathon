        ...
        <div class="row g-3 mb-3">
            <div class="col-12 col-md-6 col-lg-6">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Jane Martha</h5>
                  <p class="card-text">Jane is starting a photography company. She always loved photography at a ypung age, she found this to be her passions, so she decided to become a photographer</p>
                  <p class="card-text">Jane is seeking an amount of R25 000 which will be used for buying improved photography tools, that will help her on her journey of becoming a photographer.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <form action="fund1.php" method="post" class='container container-light bg-light rounded p-5'>
                  ...
                  <div class="row">
                        <div class="mb-3">
                          ...
                          <input type="text" name='address' class='form-control' placeholder='74126jju3BA4BUac55387o26074218e8ea8ce6bdkou88' disabled>
                        </div>
                        <div class="mb-3">
                          <label class="fomr-label">Receiver's Tax Identification Number</label>
                          <input type="text" name='address' class='form-control' placeholder='1235269580' disabled>
                        </div>

                        <div class="mb-3">
                          <label class="fomr-label">Tax Identification Number</label>
                          <input type="text" id='TIN' name='number' class='form-control' placeholder='0875694526' disabled>
                        </div>
                        <div class="mb-3">
